...
create table SpotifyClone.users_artistas (
    usuario_id int not null,
    foreign key (usuario_id) references users(id),
    artista_id int not null,
	foreign key (artista_id) references artista(id),
...
INSERT INTO SpotifyClone.musicas (cancoes, duracao_segundos, artista_id, album_id)
VALUES
  ('Soul For Us', 200, 1, 1),
...
INSERT INTO SpotifyClone.users (usuario, idade, data_assinatura, plano_id)
VALUES
...
INSERT INTO SpotifyClone.users_artistas (usuario_id, artista_id)
VALUES
  (1, 1),
  (1, 4),
  (1, 3),
